...
// This example uses only the (Handler + Runnable) combination.
// The runnable is responsible for scheduling the next event by calling the Handler.post() on itself.

public class DemoRunnableActivity extends AppCompatActivity {
    Fragment fragment;
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (textView!=null) {
                    ...
                    // After counting, post another call to runnable (this) after the same delay.
                }
